...
#                         #
###########################
setwd("~/Datos/Revisi?n consistencia logros/Distancia entre nombres")
NoDOCUMENTOS <- read.csv("~/Datos/Revisi?n consistencia logros/Distancia entre nombres/Novigentes.csv", sep=";")
vigentes   <- read.csv("~/Datos/Revisi?n consistencia logros/Distancia entre nombres/vigentes.csv", sep=";")
DOCUMENTOS <- read_excel("~/Datos/Revisi?n consistencia logros/Distancia entre nombres/CurceRegistraduriaBDUnidosSinTipoDocumento.xlsx", skip = 1)
...
DOCUMENTOS$Error_T_por_cat  <-recode_factor(DOCUMENTOS$Error_T_por_cat, `(-0.9,10]` = "0-10", `(10,20]` = "11-20", `(20,40]` = "21-40", `(40,60]` = "41-60", `(60,80]` = "60-80", `(80,210]` = "M?s de 80")

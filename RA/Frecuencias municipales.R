...
rm(list = ls()[!ls() %in% grep("DATA|Precargue|BaseGestion_2021|Carpeta|Entradas|Salidas",ls(),value = TRUE)])
...
UNIDOS_HOGARES_MUNICIPAL = UNIDOS_HOGARES_MUNICIPAL[!UNIDOS_HOGARES_MUNICIPAL$Periodo %in% 2021,]
MUNICIPAL_ESTADO_DE_LOGROS = MUNICIPAL_ESTADO_DE_LOGROS[!MUNICIPAL_ESTADO_DE_LOGROS$Periodo %in% 2021,]
MUNICIPAL_ESTADO_DE_LOGROS_I = MUNICIPAL_ESTADO_DE_LOGROS_I[!MUNICIPAL_ESTADO_DE_LOGROS_I$Periodo %in% 2021,]

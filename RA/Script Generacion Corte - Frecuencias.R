...
LOGROS_HOG = read_delim("Unidos_Logros_Hogar_20211223.txt", delim = "|", escape_double = FALSE, 
...
Precargue = read_delim("Unidos_Sabana_20211027.txt", delim = "|", escape_double = FALSE, locale = locale(encoding = "ISO-8859-1"), trim_ws = TRUE)
...
L02_AFILIACION_SALUD = L02_AFILIACION_SALUD  %>% rename(L02_AFILIACION_SALUD_ALCANZADO      = ALCANZADO,
                                                        L02_AFILIACION_SALUD_POR_ALCANZAR   = `POR ALCANZAR`,
                                                        L02_AFILIACION_SALUD_NO_DETERMINADO = `NO DETERMINADO`)
...
L02_I_AFILIACION_SALUD = L02_I_AFILIACION_SALUD %>% rename(L02_I_AFILIACION_SALUD_ALCANZADO = ALCANZADO,
                                                           L02_I_AFILIACION_SALUD_POR_ALCANZAR = `POR ALCANZAR`,
                                                           L02_I_AFILIACION_SALUD_NO_DETERMINADO = `NO DETERMINADO`)
...
L06_EDUCACION_INICIAL = L06_EDUCACION_INICIAL %>% rename(L06_EDUCACION_INICIAL_ALCANZADO = ALCANZADO,
                                                         L06_EDUCACION_INICIAL_POR_ALCANZAR = `POR ALCANZAR`,
                                                         L06_EDUCACION_INICIAL_NO_APLICA = `NO APLICA`)
...
L06_I_EDUCACION_INICIAL = L06_I_EDUCACION_INICIAL %>% rename(L06_I_EDUCACION_INICIAL_ALCANZADO = ALCANZADO,
                                                         L06_I_EDUCACION_INICIAL_POR_ALCANZAR = `POR ALCANZAR`,
                                                         L06_I_EDUCACION_INICIAL_NO_APLICA = `NO APLICA`)
...
L07_I_ESCOLARIZACION = L07_I_ESCOLARIZACION %>% rename(L07_I_ESCOLARIZACION_ALCANZADO = ALCANZADO,
                                                       L07_I_ESCOLARIZACION_POR_ALCANZAR = `POR ALCANZAR`,
                                                       L07_I_ESCOLARIZACIONL_NO_APLICA = `NO APLICA`,
                                                       L07_I_ESCOLARIZACION_NO_DETERMINADO = `NO DETERMINADO`,
                                                       L07_I_ESCOLARIZACION_GESTIONADO = GESTIONADO)
...
L07_ESCOLARIZACION = L07_ESCOLARIZACION %>% rename(L07_ESCOLARIZACION_ALCANZADO = ALCANZADO,
                                                   L07_ESCOLARIZACION_POR_ALCANZAR = `POR ALCANZAR`,
                                                   L07_ESCOLARIZACIONL_NO_APLICA = `NO APLICA`,
                                                   L07_ESCOLARIZACION_NO_DETERMINADO = `NO DETERMINADO`,
                                                   L07_ESCOLARIZACION_GESTIONADO = GESTIONADO)
...
L08_NO_TRABAJO_INFANTIL = L08_NO_TRABAJO_INFANTIL %>% rename(L08_NO_TRABAJO_INFANTIL_ALCANZADO = ALCANZADO,
                                                                 L08_NO_TRABAJO_INFANTIL_POR_ALCANZAR = `POR ALCANZAR`,
                                                                 L08_NO_TRABAJO_INFANTIL_NO_APLICA = `NO APLICA`,
                                                                 L08_NO_TRABAJO_INFANTIL_NO_DETERMINADO = `NO DETERMINADO`)
...
L08_I_NO_TRABAJO_INFANTIL = L08_I_NO_TRABAJO_INFANTIL %>% rename(L08_I_NO_TRABAJO_INFANTIL_ALCANZADO = ALCANZADO,
                                                             L08_I_NO_TRABAJO_INFANTIL_POR_ALCANZAR = `POR ALCANZAR`,
                                                             L08_I_NO_TRABAJO_INFANTIL_NO_APLICA = `NO APLICA`,
                                                             L08_I_NO_TRABAJO_INFANTIL_NO_DETERMINADO = `NO DETERMINADO`)
...
L09_I_ACCESO_A_AGUA = L09_I_ACCESO_A_AGUA %>% rename(L09_I_ACCESO_A_AGUA_NO_APLICA = `NO APLICA`)
...
L09_ACCESO_A_AGUA = L09_ACCESO_A_AGUA %>% rename(L09_ACCESO_A_AGUA_ALCANZADO = ALCANZADO,
                                                 L09_ACCESO_A_AGUA_POR_ALCANZAR = `POR ALCANZAR`,
                                                 L09_ACCESO_A_AGUA_GESTIONADO = GESTIONADO)
...
L10_I_SANEAMIENTO_BASICO = L10_I_SANEAMIENTO_BASICO %>% rename(L10_I_SANEAMIENTO_BASICO_NO_APLICA = `NO APLICA`)
...
L10_SANEAMIENTO_BASICO = L10_SANEAMIENTO_BASICO %>% rename(L10_SANEAMIENTO_BASICO_ALCANZADO = ALCANZADO,
                                                           L10_SANEAMIENTO_BASICO_POR_ALCANZAR = `POR ALCANZAR`,
                                                           L10_SANEAMIENTO_BASICO_GESTIONADO = GESTIONADO,
                                                           L10_SANEAMIENTO_BASICO_NO_DETERMINADO = `NO DETERMINADO`)
...
L17_LEER_ESCRIBIR = L17_LEER_ESCRIBIR %>% rename(L17_LEER_ESCRIBIR_ALCANZADO = ALCANZADO,
                                                     L17_LEER_ESCRIBIR_POR_ALCANZAR = `POR ALCANZAR`,
                                                     L17_LEER_ESCRIBIR_NO_APLICA = `NO APLICA`,
                                                     L17_LEER_ESCRIBIR_NO_DETERMINADO = `NO DETERMINADO`)
...
L17_I_LEER_ESCRIBIR = L17_I_LEER_ESCRIBIR %>% rename(L17_I_LEER_ESCRIBIR_ALCANZADO = ALCANZADO,
                                                 L17_I_LEER_ESCRIBIR_POR_ALCANZAR = `POR ALCANZAR`,
                                                 L17_I_LEER_ESCRIBIR_NO_APLICA = `NO APLICA`,
                                                 L17_I_LEER_ESCRIBIR_NO_DETERMINADO = `NO DETERMINADO`)
...
L18_ESTUDIOS_POSTSECUNDARIOS = L18_ESTUDIOS_POSTSECUNDARIOS %>% rename(L18_ESTUDIOS_POSTSECUNDARIOS_ALCANZADO = ALCANZADO,
                                                                           L18_ESTUDIOS_POSTSECUNDARIOS_POR_ALCANZAR = `POR ALCANZAR`,
                                                                           L18_ESTUDIOS_POSTSECUNDARIOS_NO_APLICA = `NO APLICA`,
                                                                           L18_ESTUDIOS_POSTSECUNDARIOS_NO_DETERMINADO = `NO DETERMINADO`,
                                                                           L18_ESTUDIOS_POSTSECUNDARIOS_GESTIONADO = GESTIONADO)
...
L18_I_ESTUDIOS_POSTSECUNDARIOS = L18_I_ESTUDIOS_POSTSECUNDARIOS %>% rename(L18_I_ESTUDIOS_POSTSECUNDARIOS_ALCANZADO = ALCANZADO,
                                                                       L18_I_ESTUDIOS_POSTSECUNDARIOS_POR_ALCANZAR = `POR ALCANZAR`,
                                                                       L18_I_ESTUDIOS_POSTSECUNDARIOS_NO_APLICA = `NO APLICA`,
                                                                       L18_I_ESTUDIOS_POSTSECUNDARIOS_NO_DETERMINADO = `NO DETERMINADO`,
                                                                       L18_I_ESTUDIOS_POSTSECUNDARIOS_GESTIONADO = GESTIONADO)
...
L21_NO_PISOS_TIERRA = L21_NO_PISOS_TIERRA %>% rename(L21_NO_PISOS_TIERRA_ALCANZADO = ALCANZADO,
                                                     L21_NO_PISOS_TIERRA_POR_ALCANZAR = `POR ALCANZAR`,
                                                     L21_NO_PISOS_TIERRA_NO_DETERMINADO = `NO DETERMINADO`,
                                                     L21_NO_PISOS_TIERRA_GESTIONADO = GESTIONADO)
...
L21_I_NO_PISOS_TIERRA = L21_I_NO_PISOS_TIERRA %>% rename(L21_I_NO_PISOS_TIERRA_NO_APLICA = `NO APLICA`)
...
L22_I_PAREDES_ADECUADAS = L22_I_PAREDES_ADECUADAS %>% rename(L22_I_PAREDES_ADECUADAS_NO_APLICA = `NO APLICA`)
...
L22_PAREDES_ADECUADAS = L22_PAREDES_ADECUADAS %>% rename(L22_PAREDES_ADECUADAS_ALCANZADO = ALCANZADO,
                                                         L22_PAREDES_ADECUADAS_POR_ALCANZAR = `POR ALCANZAR`,
                                                         L22_PAREDES_ADECUADAS_GESTIONADO = GESTIONADO)
...
L23_I_NO_HACINAMIENTO = L23_I_NO_HACINAMIENTO %>% rename(L23_I_NO_HACINAMIENTO_NO_APLICA = `NO APLICA`)
...
L23_NO_HACINAMIENTO = L23_NO_HACINAMIENTO %>% rename(L23_NO_HACINAMIENTO_ALCANZADO = ALCANZADO,
                                                     L23_NO_HACINAMIENTO_POR_ALCANZAR = `POR ALCANZAR`)
...
L25_I_ACTIVIDAD_PRODUCTIVA = L25_I_ACTIVIDAD_PRODUCTIVA %>% rename(L25_I_ACTIVIDAD_PRODUCTIVA_ALCANZADO = ALCANZADO,
                                                                   L25_I_ACTIVIDAD_PRODUCTIVA_POR_ALCANZAR = `POR ALCANZAR`,
                                                                   L25_I_ACTIVIDAD_PRODUCTIVA_NO_APLICA = `NO APLICA`,
                                                                   L25_I_ACTIVIDAD_PRODUCTIVA_NO_DETERMINADO = `NO DETERMINADO`,
                                                                   L25_I_ACTIVIDAD_PRODUCTIVA_GESTIONADO = GESTIONADO)
...
L25_ACTIVIDAD_PRODUCTIVA = L25_ACTIVIDAD_PRODUCTIVA %>% rename(L25_ACTIVIDAD_PRODUCTIVA_ALCANZADO = ALCANZADO,
                                                               L25_ACTIVIDAD_PRODUCTIVA_POR_ALCANZAR = `POR ALCANZAR`,
                                                               L25_ACTIVIDAD_PRODUCTIVA_NO_APLICA = `NO APLICA`,
                                                               L25_ACTIVIDAD_PRODUCTIVA_NO_DETERMINADO = `NO DETERMINADO`,
                                                               L25_ACTIVIDAD_PRODUCTIVA_GESTIONADO = GESTIONADO)
...
L27_I_MFA = L27_I_MFA %>% rename(L27_I_MFA_ALCANZADO = ALCANZADO,
                                 L27_MFA_I_POR_ALCANZAR = `POR ALCANZAR`,
                                 L27_MFA_I_NO_APLICA = `NO APLICA`)
...
L27_MFA = L27_MFA %>% rename(L27_MFA_ALCANZADO = ALCANZADO,
                             L27_MFA_POR_ALCANZAR = `POR ALCANZAR`,
                             L27_MFA_NO_APLICA = `NO APLICA`)
...
BaseGestionFrecuencias = BaseGestionFrecuencias %>% select(Departamento, CodigoDepartamento, CodigoMunicipio, MUNICIPIO,
                                                           
                                                           DISCAPACIDAD_SI, DISCAPACIDAD_NO, DISCAPACIDAD_SIN_DATO,
                                                           
                                                           DISCAPACIDAD_VER_SI, DISCAPACIDAD_OIR_SI, DISCAPACIDAD_HABLAR_SI, DISCAPACIDAD_MOVERSE_SI,
                                                           DISCAPACIDAD_BañaRSE_VESTIRSE_SI,
                                                           DISCAPACIDAD_SALIR_A_LA_CALLE_SI, DISCAPACIDAD_ENTENDER_APRENDER_SI,
                                                           
                                                           SEXO_HOMBRE, SEXO_MUJER, "1. Primera Infancia", "2. Ni?ez", "3. Adolescencia", "4. Juventud", "5. Adulto", "6. Adulto Mayor",
                                                           TOTAL_INTEGRANTES, TOTAL_HOGARES, `Cabecera Municipal`, `Centro Poblado`, `Rural Disperso`,
                                                           
                                                           L02_AFILIACION_SALUD_ALCANZADO, L02_AFILIACION_SALUD_POR_ALCANZAR, L02_AFILIACION_SALUD_NO_DETERMINADO,
                                                           L02_I_AFILIACION_SALUD_ALCANZADO, L02_I_AFILIACION_SALUD_POR_ALCANZAR, L02_I_AFILIACION_SALUD_NO_DETERMINADO,
                                                           
                                                           L06_EDUCACION_INICIAL_ALCANZADO, L06_EDUCACION_INICIAL_POR_ALCANZAR, L06_EDUCACION_INICIAL_NO_APLICA,
                                                           L06_I_EDUCACION_INICIAL_ALCANZADO, L06_I_EDUCACION_INICIAL_POR_ALCANZAR, L06_I_EDUCACION_INICIAL_NO_APLICA,
                                                           
                                                           L07_ESCOLARIZACION_ALCANZADO, L07_ESCOLARIZACION_POR_ALCANZAR, L07_ESCOLARIZACION_GESTIONADO, L07_ESCOLARIZACION_NO_DETERMINADO, L07_ESCOLARIZACIONL_NO_APLICA,
                                                           L07_I_ESCOLARIZACION_ALCANZADO, L07_I_ESCOLARIZACION_POR_ALCANZAR, L07_I_ESCOLARIZACION_GESTIONADO, L07_I_ESCOLARIZACION_NO_DETERMINADO, L07_I_ESCOLARIZACIONL_NO_APLICA,
                                                           
                                                           L08_NO_TRABAJO_INFANTIL_ALCANZADO, L08_NO_TRABAJO_INFANTIL_POR_ALCANZAR, L08_NO_TRABAJO_INFANTIL_NO_DETERMINADO, L08_NO_TRABAJO_INFANTIL_NO_APLICA,
                                                           L08_I_NO_TRABAJO_INFANTIL_ALCANZADO, L08_I_NO_TRABAJO_INFANTIL_POR_ALCANZAR, L08_I_NO_TRABAJO_INFANTIL_NO_DETERMINADO, L08_I_NO_TRABAJO_INFANTIL_NO_APLICA,
                                                           
                                                           L09_ACCESO_A_AGUA_ALCANZADO, L09_ACCESO_A_AGUA_POR_ALCANZAR, L09_ACCESO_A_AGUA_GESTIONADO,
                                                           L09_I_ACCESO_A_AGUA_NO_APLICA,
                                                           
                                                           L10_SANEAMIENTO_BASICO_ALCANZADO, L10_SANEAMIENTO_BASICO_POR_ALCANZAR, L10_SANEAMIENTO_BASICO_GESTIONADO, L10_SANEAMIENTO_BASICO_NO_DETERMINADO,
                                                           L10_I_SANEAMIENTO_BASICO_NO_APLICA,
                                                           
                                                           L17_LEER_ESCRIBIR_ALCANZADO, L17_LEER_ESCRIBIR_POR_ALCANZAR, L17_LEER_ESCRIBIR_NO_DETERMINADO, L17_LEER_ESCRIBIR_NO_APLICA,
                                                           L17_I_LEER_ESCRIBIR_ALCANZADO, L17_I_LEER_ESCRIBIR_POR_ALCANZAR, L17_I_LEER_ESCRIBIR_NO_DETERMINADO, L17_I_LEER_ESCRIBIR_NO_APLICA,
                                                           
                                                           L18_ESTUDIOS_POSTSECUNDARIOS_ALCANZADO, L18_ESTUDIOS_POSTSECUNDARIOS_POR_ALCANZAR, L18_ESTUDIOS_POSTSECUNDARIOS_GESTIONADO, L18_ESTUDIOS_POSTSECUNDARIOS_NO_DETERMINADO, L18_ESTUDIOS_POSTSECUNDARIOS_NO_APLICA,
                                                           L18_I_ESTUDIOS_POSTSECUNDARIOS_ALCANZADO, L18_I_ESTUDIOS_POSTSECUNDARIOS_POR_ALCANZAR, L18_I_ESTUDIOS_POSTSECUNDARIOS_GESTIONADO, L18_I_ESTUDIOS_POSTSECUNDARIOS_NO_DETERMINADO, L18_I_ESTUDIOS_POSTSECUNDARIOS_NO_APLICA,
                                                           
                                                           L21_NO_PISOS_TIERRA_ALCANZADO, L21_NO_PISOS_TIERRA_POR_ALCANZAR, L21_NO_PISOS_TIERRA_GESTIONADO, L21_NO_PISOS_TIERRA_NO_DETERMINADO,
                                                           L21_I_NO_PISOS_TIERRA_NO_APLICA,
                                                           
                                                           L22_PAREDES_ADECUADAS_ALCANZADO, L22_PAREDES_ADECUADAS_POR_ALCANZAR, L22_PAREDES_ADECUADAS_GESTIONADO,
                                                           L22_I_PAREDES_ADECUADAS_NO_APLICA,
                                                           
                                                           L23_NO_HACINAMIENTO_ALCANZADO, L23_NO_HACINAMIENTO_POR_ALCANZAR,
                                                           L23_I_NO_HACINAMIENTO_NO_APLICA,
                                                           
                                                           L25_ACTIVIDAD_PRODUCTIVA_ALCANZADO, L25_ACTIVIDAD_PRODUCTIVA_POR_ALCANZAR, L25_ACTIVIDAD_PRODUCTIVA_GESTIONADO, L25_ACTIVIDAD_PRODUCTIVA_NO_DETERMINADO, L25_ACTIVIDAD_PRODUCTIVA_NO_APLICA,
                                                           L25_I_ACTIVIDAD_PRODUCTIVA_ALCANZADO, L25_I_ACTIVIDAD_PRODUCTIVA_POR_ALCANZAR, L25_I_ACTIVIDAD_PRODUCTIVA_GESTIONADO, L25_I_ACTIVIDAD_PRODUCTIVA_NO_DETERMINADO, L25_I_ACTIVIDAD_PRODUCTIVA_NO_APLICA,
                                                           
                                                           L27_MFA_ALCANZADO, L27_MFA_POR_ALCANZAR, L27_MFA_NO_APLICA,
                                                           L27_I_MFA_ALCANZADO, L27_MFA_I_POR_ALCANZAR, L27_MFA_I_NO_APLICA,
